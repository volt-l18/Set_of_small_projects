...
ttk.Entry(Calwindow,show=True,textvariable=equation).grid(columnspan=4 , padx= 60 , pady= 4)
...
ttk.Button(Calwindow, text="=", command=lambda:press("=")).grid(column=3, row=4)
